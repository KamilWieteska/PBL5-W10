package com.iot.workshop.devicesimulator.aws;

import com.iot.workshop.devicesimulator.aws.utils.CommandLineUtils;
...
public class PubSub {
    ...
    public static void main( String[] args ) {
        ...
        messagesToPublish =
                Integer.parseInt( cmdUtils.getCommandOrDefault( "count", String.valueOf( messagesToPublish ) ) );
